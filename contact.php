...
<head>
    ...
    <title>Contact Us — Rajdoot Paints</title>
    ...
    <link rel="stylesheet" href="css/pc/contact.css" media="screen and (min-width: 1025px)">
    <link rel="stylesheet" href="css/mobile/contact.css" media="screen and (max-width: 1024px)">
