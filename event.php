...
<head>
    ...
    <title>Events — Rajdoot Paints</title>
    ...
    <link rel="stylesheet" href="https://fonts.googleapis.com/css2?family=Outfit:wght@400;500;600;700&display=swap" media="print" onload="this.media='all'">
    ...
    <link rel="stylesheet" href="css/pc/event-page.css" media="screen and (min-width: 1025px)">
    <link rel="stylesheet" href="css/mobile/event-page.css" media="screen and (max-width: 1024px)">
...
<body>
    ...
    <main class="site-main" style="padding-top: 70px;">
